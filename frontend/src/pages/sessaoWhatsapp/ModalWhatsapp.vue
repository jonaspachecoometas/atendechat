    ...
    >
      <q-card class="q-pa-md"
        ...
        <q-card-section>
          <div class="row">
            ...
            <div class="col-12 section primary-gradient" v-if="whatsapp.type !== 'webmail'">
              <div class="col-12 q-my-sm">
                ...
                <q-tooltip v-if="!whatsapp.id">
                  {{ $t('sessaoModalWhatsapp.configureAfterCreate') }}
                </q-tooltip>
                <div style="width: 100%;" :class="{ 'cursor-not-allowed': !whatsapp.id }" v-if="!whatsapp.id">
                  <q-select
                    outlined
                    dense
          ...
          <div class="section primary-gradient col-12" v-if="['whatsapp', 'baileys', 'meow', 'evo', 'uazapi', 'zapi', 'waba'].includes(whatsapp.type)">
            <div class="text-h8" style="margin-top: 20px;" v-if="['whatsapp', 'baileys', 'meow', 'evo', 'uazapi', 'zapi', 'waba'].includes(whatsapp.type)">Wavoip</div>
            <div class="col-12 q-my-sm" v-if="['whatsapp', 'baileys', 'meow', 'evo', 'uazapi', 'zapi', 'waba'].includes(whatsapp.type)">
