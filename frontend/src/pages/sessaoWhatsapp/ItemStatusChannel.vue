  ...
  <div class="status-card">
    <q-item>
      ...
      <q-item-section>
        ...
        <!-- Ícones de configuração: ChatFlow, Queue, User e Contingência -->
        <q-item-label v-if="item.chatFlowId || item.queueId || item.userId || item.isActive === false" style="margin-top: 6px;">
          <span style="display: inline-flex; align-items: center; gap: 8px;">
            ...
            <q-icon 
              ...
              size="18px" 
              color="primary">
              <q-tooltip>{{ $t('sessaoItemStatus.contingencyInactive') }}</q-tooltip>
            </q-icon>
          </span>
        </q-item-label>
      </q-item-section>
