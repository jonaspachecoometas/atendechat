                ...
                <div class="row items-center no-wrap" style="flex-wrap: wrap; justify-content: space-between;">
                  ...
                  >
                    <q-list>
                      ...
                      <q-item clickable @click="setDefault(item)" :disable="!isAdmin || !isAllowedTypeForDefault(item.type)">
                        <q-item-section avatar>
          ...
          <template v-if="!isCompactView">
            ...
            >
              ...
              <q-btn
                ...
                :disable="!isAdmin || !isAllowedTypeForDefault(item.type)"
                dense
                round
                flat
                class="absolute-bottom-right"
...
export default {
  ...
  methods: {
    ...
    isAllowedTypeForDefault(type) {
      const allowedTypes = ['waba', 'whatsapp', 'baileys', 'meow', 'uazapi', 'zapi', 'evo'];
      return allowedTypes.includes(type);
    },
    async setDefault(whatsapp){
      // Verificar se o tipo é permitido antes de executar
      if (!this.isAllowedTypeForDefault(whatsapp.type)) {
        this.$q.notify({
          type: 'negative',
          message: this.$t('sessao.defaultNotAllowedForType') || 'Esta operação não é permitida para este tipo de conexão.',
          position: 'top'
        });
        return;
      }
