        ...
        <q-card-section>
          <div class="row">
            ...
            <div class="col-12"
              ...
              <div class="q-tabs row items-center">
                <div class="q-tab" :class="{ 'q-tab--active': activeTab === 'tab1' }" @click="activeTab = 'tab1'" style="background-color: #f2f2f2; border-radius: 8px 10px 0 0; text-transform: capitalize;">Informações</div>
