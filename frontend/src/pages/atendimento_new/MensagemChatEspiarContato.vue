...
.q-chat-message .q-message-container {
  border-radius: 12px;
...
.hr-text {
  &:before {
    background: linear-gradient(to right, transparent, #bdbdbd, transparent) !important;
  }
  &:after {
...
body.body--dark .q-input, body.body--dark .q-select, body.body--dark textarea {
...
body.body--dark .ticket-info {
  background: rgba(30,30,30,0.92) !important;
  color: #bdbdbd !important;
  border: 1px solid #333;
}
body.body--dark .reaction-container {
