          ...
          <q-tab-panel name="termos">
            <div class="contract-content">
              ...
              <ul>
                ...
                <li>Revenda do instalador/código fonte em: marketplaces, grupos de rateio, grupos de compra, cursos ou comunidades</li>
                <li>Conforme item acima, não está autorizada a instalação do código ou fornecimento do instalador em servidores de terceiros, fora da infra-estrutura do Cliente.</li>
                <li>Uso das marcas Comunidade ZDG, Passaporte ZDG, Z-PRO, Pedrinho da NASA, respectivas logomarcas e demais materiais que são de propriedade ZDG [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67]</li>
              </ul>
              <p>A [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67] reserva o direito de conduzir investigações internas quando suspeitar de ocorrência de uso em desconformidade com estes Termos e, no limite, revogar a licença de utilização do Cliente e seus Usuários, ainda que os Usuários sejam terceiros pagantes de licença de uso contratada pelo Cliente.</p>

              <p><strong>2.4. Suporte técnico</strong></p>
              <p>O Z-PRO conta com um time de suporte de segunda-feira à sexta-feira com prazo de primeiro atendimento de até 72 (setenta e duas) horas úteis a contar da hora de início do chamado, com atendimentos via ticket na Plataforma TomTicket e através do Canal de Atendimento <a href="mailto:comunidadezdg@gmail.com">comunidadezdg@gmail.com</a>.</p>
              ...
              <p>Acesse o link para mais detalhes sobre as condições de uso: 
                <a href="https://zpro.passaportezdg.com.br/" target="_blank">https://zpro.passaportezdg.com.br/</a>
              </p>
              ...
              <ul>
                ...
                <li>Processador i5 ou superior</li>
              ...
              <ul>
                ...
                <li>Ubuntu 20.04 ou 22.04 LTS sem painel</li>
                <li>Arquitetura AMD</li>
                <li>SSD ou NVMe à partir de 200gb</li>
              </ul>
              <p>Os requisitos de uso e informações técnicas estão detalhadas no link: 
                <a href="https://zpro.passaportezdg.com.br/requisitos-de-uso" target="_blank">
                  https://zpro.passaportezdg.com.br/requisitos-de-uso
                </a>
              </p>
              ...
              <p>A ZPRO foi desenvolvida para utilizar a API Oficial do WhatsApp como padrão de conexão. A API Oficial garante maior estabilidade, segurança, e suporte direto da Meta, sendo a única opção para a qual oferecemos garantia de funcionalidade e estabilidade, com base nos termos de uso da Plataforma Whatsap.</p>
              <p>Para maior flexibilidade, o sistema permite a integração com APIs Não Oficiais, como WWebJS, Baileys, Meow e Evolution. Destacamos que o uso dessas APIs é de total responsabilidade do usuário, que deve estar ciente dos riscos associados, incluindo, mas não se limitando a:</p>
              <ul>
                <li>Desconexões frequentes</li>
                <li>Perda de mensagens enviadas ou recebidas</li>
                <li>Instabilidade no funcionamento</li>
                <li>Possíveis bloqueios de contas</li>
              </ul>
              <p>Não garantimos a estabilidade, o desempenho ou o suporte técnico para integrações realizadas por meio de APIs Não Oficiais. Recomendamos fortemente o uso da API Oficial do WhatsApp para assegurar uma experiência mais estável e confiável.</p>
              <p>Ao habilitar a conexão com uma API Não Oficial, o usuário assume integralmente todos os riscos e isenta a plataforma de qualquer responsabilidade por eventuais perdas, danos diretos ou indiretos decorrentes do uso dessas integrações.</p>
              <p>Para orientações sobre o uso adequado das APIs, consulte nosso manual de boas práticas no link: : 
                <a href="https://zpro.passaportezdg.com.br/api-oficial-vs-api-nao-oficial" target="_blank">
                  https://zpro.passaportezdg.com.br/api-oficial-vs-api-nao-oficial
                </a>
              </p>
              ...
              <p>A titularidade e os direitos relativos ao Z-PRO pertencem exclusivamente à [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67].</p>
              <p>O Usuário não adquire em razão do acesso e utilização regular do Z-PRO ou por meio destes Termos ou outro documento elaborado e/ou divulgado pela [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67] nenhum direito de propriedade intelectual ou outros direitos exclusivos, incluindo patentes, desenhos, marcas, direitos autorais ou direitos sobre informações confidenciais ou segredos de negócio sobre ou relacionados ao Z-PRO, os quais são de propriedade exclusiva da [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67].</p>
              <p>Dessa forma, não é permitido fazer nenhum tipo de utilização do conteúdo sem autorização prévia e expressa do Z-PRO, seja reprodução, alteração parcial, otimização, cópia ou outros meios de qualquer um dos elementos protegidos pela propriedade intelectual da [BIANCA SANT ANA PEREIRA LTDA - CNPJ: 35.617.749/0001-67], única e exclusiva licenciadora do Software as a Service Z-PRO na forma prevista no seu Plano de Assinatura e nestes Termos.</p>
