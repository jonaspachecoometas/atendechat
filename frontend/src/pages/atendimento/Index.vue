  ...
  <div class="WAL position-relative bg-grey-3" :style="style">
    <q-layout class="WAL__layout shadow-3" container view="lHr LpR lFr">
      ...
      <q-toolbar class="q-pr-none q-gutter-xs full-width" style="height: 64px">
        ...
        <q-toolbar v-show="toolbarSearch" class="row q-gutter-xs q-py-sm items-center">
          <q-separator class="absolute-top" />
          ...
          <q-btn flat class="bg-padrao btn-rounded" :icon="sortByAnswered ? 'mdi-check-circle' : 'mdi-check-circle-outline'" @click="toggleSortByAnswered" :color="sortByAnswered ? 'primary' : ''" style="flex: 1; font-size: 12px">
            <q-tooltip> {{ $t('generalSupport.sortByAnswered') || 'Organizar por Respondido' }}</q-tooltip>
          </q-btn>
...
export default {
  ...
  computed: {
    ...
    openTicketsReversed() {
      ...
      if(this.sortByAnswered){
        return [...tickets].sort((a, b) => {
          const aAnswered = a.answered === true;
          const bAnswered = b.answered === true;
  ...
  methods: {
    ...
    toggleSortByAnswered() {
      this.sortByAnswered = !this.sortByAnswered;
    },
