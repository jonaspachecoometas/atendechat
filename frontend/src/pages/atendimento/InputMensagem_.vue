        ...
        <q-card style="min-width: 350px">
          ...
          <q-card-section class="q-pt-none">
            ...
            <div class="row q-gutter-sm q-mt-sm">
              <div class="col-4">
                <q-select
                  v-model="vcardData.countryCode"
                  :label="$t('inputMensagem.labels.codigoPais')"
                  ...
                  outlined
                  dense
                  class="phone-field-height"
                  @update:model-value="onCountryCodeUpdate"
                >
                  ...
                  <template v-slot:selected>
                    <div class="row items-center no-wrap" style="line-height: 1.2;">
                      <span class="text-body2 q-mr-xs">{{ getSelectedCountryFlag() }}</span>
                      <span class="text-caption">{{ getSelectedCountryDialCode() }}</span>
                    </div>
                  </template>
                </q-select>
              </div>
              <div class="col">
                <q-input
                  ...
                  :label="$t('inputMensagem.labels.numeroTelefone')"
                  :rules="[val => !!val || $t('inputMensagem.novo.camposObrigatorios')]"
                  outlined
                  dense
                  class="phone-field-height"
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      countryOptions: [
        ...
        { code: 'AS', label: 'American Samoa', dialCode: '+1684', flag: '🇦🇸' },
        { code: 'AD', label: 'Andorra', dialCode: '+376', flag: '🇦🇩' },
        { code: 'AO', label: 'Angola', dialCode: '+244', flag: '🇦🇴' },
        { code: 'AI', label: 'Anguilla', dialCode: '+1264', flag: '🇦🇮' },
        { code: 'AQ', label: 'Antarctica', dialCode: '+672', flag: '🇦🇶' },
        { code: 'AG', label: 'Antigua and Barbuda', dialCode: '+1268', flag: '🇦🇬' },
        ...
        { code: 'BS', label: 'Bahamas', dialCode: '+1242', flag: '🇧🇸' },
        { code: 'BH', label: 'Bahrain', dialCode: '+973', flag: '🇧🇭' },
        { code: 'BD', label: 'Bangladesh', dialCode: '+880', flag: '🇧🇩' },
        { code: 'BB', label: 'Barbados', dialCode: '+1246', flag: '🇧🇧' },
        ...
        { code: 'BM', label: 'Bermuda', dialCode: '+1441', flag: '🇧🇲' },
        ...
        { code: 'KY', label: 'Cayman Islands', dialCode: '+1345', flag: '🇰🇾' },
        ...
        { code: 'CD', label: 'Congo, Democratic Republic of the', dialCode: '+243', flag: '🇨🇩' },
        { code: 'CK', label: 'Cook Islands', dialCode: '+682', flag: '🇨🇰' },
        { code: 'CR', label: 'Costa Rica', dialCode: '+506', flag: '🇨🇷' },
        { code: 'CI', label: 'Cote D\'Ivoire', dialCode: '+225', flag: '🇨🇮' },
        ...
        { code: 'DM', label: 'Dominica', dialCode: '+1767', flag: '🇩🇲' },
        { code: 'DO', label: 'Dominican Republic', dialCode: '+1809', flag: '🇩🇴' },
        ...
        { code: 'FK', label: 'Falkland Islands (Malvinas)', dialCode: '+500', flag: '🇫🇰' },
        ...
        { code: 'GD', label: 'Grenada', dialCode: '+1473', flag: '🇬🇩' },
        { code: 'GP', label: 'Guadeloupe', dialCode: '+590', flag: '🇬🇵' },
        { code: 'GU', label: 'Guam', dialCode: '+1671', flag: '🇬🇺' },
        ...
        { code: 'VA', label: 'Holy See (Vatican City State)', dialCode: '+379', flag: '🇻🇦' },
        ...
        { code: 'IR', label: 'Iran, Islamic Republic of', dialCode: '+98', flag: '🇮🇷' },
        ...
        { code: 'JM', label: 'Jamaica', dialCode: '+1876', flag: '🇯🇲' },
        ...
        { code: 'KP', label: 'Korea, Democratic People\'s Republic of', dialCode: '+850', flag: '🇰🇵' },
        { code: 'KR', label: 'Korea, Republic of', dialCode: '+82', flag: '🇰🇷' },
        { code: 'KW', label: 'Kuwait', dialCode: '+965', flag: '🇰🇼' },
        { code: 'KG', label: 'Kyrgyzstan', dialCode: '+996', flag: '🇰🇬' },
        { code: 'LA', label: 'Lao People\'s Democratic Republic', dialCode: '+856', flag: '🇱🇦' },
        ...
        { code: 'LY', label: 'Libyan Arab Jamahiriya', dialCode: '+218', flag: '🇱🇾' },
        ...
        { code: 'MO', label: 'Macao', dialCode: '+853', flag: '🇲🇴' },
        { code: 'MK', label: 'Macedonia, the Former Yugoslav Republic of', dialCode: '+389', flag: '🇲🇰' },
        ...
        { code: 'FM', label: 'Micronesia, Federated States of', dialCode: '+691', flag: '🇫🇲' },
        { code: 'MD', label: 'Moldova, Republic of', dialCode: '+373', flag: '🇲🇩' },
        { code: 'MC', label: 'Monaco', dialCode: '+377', flag: '🇲🇨' },
        { code: 'MN', label: 'Mongolia', dialCode: '+976', flag: '🇲🇳' },
        { code: 'ME', label: 'Montenegro', dialCode: '+382', flag: '🇲🇪' },
        { code: 'MS', label: 'Montserrat', dialCode: '+1664', flag: '🇲🇸' },
        ...
        { code: 'AN', label: 'Netherlands Antilles', dialCode: '+599', flag: '🇳🇱' },
        ...
        { code: 'MP', label: 'Northern Mariana Islands', dialCode: '+1670', flag: '🇲🇵' },
        ...
        { code: 'PS', label: 'Palestinian Territory, Occupied', dialCode: '+970', flag: '🇵🇸' },
        ...
        { code: 'PR', label: 'Puerto Rico', dialCode: '+1787', flag: '🇵🇷' },
        { code: 'QA', label: 'Qatar', dialCode: '+974', flag: '🇶🇦' },
        { code: 'RE', label: 'Reunion', dialCode: '+262', flag: '🇷🇪' },
        { code: 'RO', label: 'Romania', dialCode: '+40', flag: '🇷🇴' },
        { code: 'RU', label: 'Russian Federation', dialCode: '+7', flag: '🇷🇺' },
        { code: 'RW', label: 'Rwanda', dialCode: '+250', flag: '🇷🇼' },
        { code: 'BL', label: 'Saint Barthelemy', dialCode: '+590', flag: '🇧🇱' },
        { code: 'SH', label: 'Saint Helena', dialCode: '+290', flag: '🇸🇭' },
        { code: 'KN', label: 'Saint Kitts and Nevis', dialCode: '+1869', flag: '🇰🇳' },
        { code: 'LC', label: 'Saint Lucia', dialCode: '+1758', flag: '🇱🇨' },
        { code: 'MF', label: 'Saint Martin', dialCode: '+590', flag: '🇲🇫' },
        { code: 'PM', label: 'Saint Pierre and Miquelon', dialCode: '+508', flag: '🇵🇲' },
        { code: 'VC', label: 'Saint Vincent and the Grenadines', dialCode: '+1784', flag: '🇻🇨' },
        ...
        { code: 'SZ', label: 'Swaziland', dialCode: '+268', flag: '🇸🇿' },
        { code: 'SE', label: 'Sweden', dialCode: '+46', flag: '🇸🇪' },
        { code: 'CH', label: 'Switzerland', dialCode: '+41', flag: '🇨🇭' },
        { code: 'SY', label: 'Syrian Arab Republic', dialCode: '+963', flag: '🇸🇾' },
        { code: 'TW', label: 'Taiwan, Province of China', dialCode: '+886', flag: '🇹🇼' },
        { code: 'TJ', label: 'Tajikistan', dialCode: '+992', flag: '🇹🇯' },
        { code: 'TZ', label: 'Tanzania, United Republic of', dialCode: '+255', flag: '🇹🇿' },
        ...
        { code: 'UM', label: 'United States Minor Outlying Islands', dialCode: '+1', flag: '🇺🇸' },
        ...
        { code: 'VN', label: 'Viet Nam', dialCode: '+84', flag: '🇻🇳' },
        { code: 'VG', label: 'Virgin Islands, British', dialCode: '+1284', flag: '🇻🇬' },
        { code: 'VI', label: 'Virgin Islands, U.s.', dialCode: '+1340', flag: '🇻🇮' },
  ...
  methods: {
    ...
    onCountryCodeUpdate() {
      this.updateFormatInternational();
    },
    ...
    updateFormatInternational() {
      if (this.vcardData.countryCode && this.vcardData.phoneNumber) {
        const country = this.countryOptions.find(c => c.code === this.vcardData.countryCode);
        if (country) {
          // Remove caracteres não numéricos do número
          const cleanNumber = this.vcardData.phoneNumber.replace(/\D/g, '');
          this.formatInternational = `${country.dialCode}${cleanNumber}`;
        }
      } else {
        this.formatInternational = '';
      }
    ...
    getSelectedCountryDialCode() {
      const country = this.countryOptions.find(c => c.code === this.vcardData.countryCode);
      return country ? country.dialCode : '+55';
    },
