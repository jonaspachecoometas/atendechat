    ...
    <div class="card-content">
      ...
      <div class="card-info blur-effect">
        ...
        <div class="card-actions">
          <q-btn v-if="cSessionsWpp.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicket">
            <q-tooltip>{{ $t('cardsTags.actions.whatsapp') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsBaileys.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketBaileys">
            <q-tooltip>{{ $t('cardsTags.actions.baileys') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsMeow.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketMeow">
            <q-tooltip>{{ $t('cardsTags.actions.meow') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsEvo.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketEvo">
            <q-tooltip>{{ $t('cardsTags.actions.evo') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsZapi.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketZapi">
            <q-tooltip>{{ $t('cardsTags.actions.zapi') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsUazapi.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketUazapi">
            <q-tooltip>{{ $t('cardsTags.actions.uazapi') }}</q-tooltip>
          </q-btn>
          <q-btn v-if="cSessionsWaba.length > 0 && data.description" style="font-size: 8px;" flat round icon="mdi-whatsapp" class="text-whatsapp card-btn" @click="abrirTicketWaba">
