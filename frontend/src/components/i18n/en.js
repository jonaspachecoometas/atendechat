export default {
  ...
  modalApi: {
    ...
    apiSessionHint: "Optional. Leave empty for query/listing APIs that don't require a session",
    ...
    wabaBannerDescription2:
      "SendMessageParams, SendMessageAPIFile, SendMessageAPIFileURL, SendMessageAPIText, and SendMessageAPITextBase64",
  ...
  listChatflow: {
    ...
    actions: {
      ...
      delete: "Delete",
      newVersion: "New Version (Vue Flow)",
      newVersionDesc: "Modern and updated interface",
      oldVersion: "Old Version (jsPlumb)",
      oldVersionDesc: "Original interface with jsPlumb"
    },
    confirmDelete: {
  ...
  chatPrivado: {
    ...
    messages: {
      ...
      clickToRemoveReaction: "Click to remove reaction",
    ...
    notifications: {
      ...
      reactionError: "Error adding reaction",
      messageForwarded: "Message forwarded successfully!",
      forwardError: "Error forwarding message"
    },
  },
  ...
  configuracoesDify: {
    labels: {
      enableDify: "Enable Dify Integration ",
  ...
  configuracoesGemini: {
    labels: {
      enableGemini: "Enable Gemini Integration ",
  ...
  configuracoesDeepseek: {
    labels: {
      enableDeepseek: "Enable Deepseek Integration ",
  ...
  configuracoesQwen: {
    labels: {
      enableQwen: "Enable Qwen Integration ",
  ...
  configuracoesGrok: {
    labels: {
      enableGrok: "Enable Grok Integration ",
  ...
  configuracaoMeta: {
    ...
    webhookInstagramTooltip: "Click to copy Instagram webhook",
    webhookInstagramCopied: "Instagram webhook copied successfully!",
    webhookMessenger: "Messenger Webhook",
    webhookMessengerTooltip: "Click to copy Messenger webhook",
    webhookMessengerCopied: "Messenger webhook copied successfully!",
    ...
    facebook: {
      ...
      description: "Log in with your Facebook account to access Meta Business resources",
      loginTab: "Login",
      selectApp: "Select App",
      noAppsAvailable: "No apps available",
      errorLoadingApps: "Error loading available apps",
      appId: "App ID",
      appIdHint: "Facebook application ID",
      ...
      connected: "Successfully connected to Facebook!",
      notConnected: "You need to be connected to Facebook",
      notAuthorized: "You need to authorize the application",
      loggedOut: "Successfully logged out!",
      statusConnected: "Connected",
      statusNotAuthorized: "Not Authorized",
      statusUnknown: "Unknown",
      userInfo: "User Information",
      wabaManagement: "Manage WABAs and Numbers",
      loadWabas: "Load WABAs",
      noWabas: "No WABAs found. Click 'Load WABAs' to search.",
      noBusinessAccounts: "No business accounts found",
      noWabasFound: "No WABAs found in your business accounts",
      loadPhones: "Load Numbers",
      phoneNumbers: "Phone Numbers",
      noPhonesFound: "No phone numbers found in this WABA",
      createChannel: "Create Channel",
      channelName: "Channel Name",
      channelNameHint: "Enter a name to identify this channel",
      wabaId: "WABA ID",
      phoneNumberId: "Phone Number ID",
      displayPhoneNumber: "Phone Number",
      wabaVersion: "WABA Version",
      wabaVersionHint: "API version (e.g., v24.0)",
      create: "Create",
      channelCreated: "Channel created successfully!",
      addPhoneNumber: "Add Number",
      addWaba: "Add WABA",
      addWabaAndNumber: "Add WABA and Number",
      phoneNumber: "Phone Number",
      phoneNumberRequired: "Please enter the phone number",
      startOnboarding: "Start Onboarding",
      onboardingInfo: "A verification code will be sent via SMS to the provided number. You will need to verify the code to complete the process.",
      onboardingWabaInfo: "A new phone number will be added to an existing WABA or a new number will be created. A verification code will be sent via SMS.",
      phoneOnboardingStarted: "Onboarding started! Check the SMS on the provided number to complete verification.",
      creatingWaba: "Creating new WABA...",
      wabaCreated: "WABA created successfully!",
      wabaCreationNotSupported: "WABA creation via API is not available. Please create a WABA manually in Facebook Business Manager and try again.",
      wabaCreationError: "Error creating WABA. Please create a WABA manually in Facebook Business Manager.",
      noTokenConfigured: "No token configured for this app. Using user token.",
      embeddedSignup: "Add Whatsapp",
      embeddedSignupConfigId: "Config ID (Embedded Signup)",
      embeddedSignupConfigIdHint: "Embedded Signup configuration ID",
      embeddedSignupFinished: "Embedded signup completed successfully!",
      embeddedSignupCancelled: "Embedded signup cancelled",
      embeddedSignupError: "Error in embedded signup",
      codeReceived: "Code received. Waiting for flow completion...",
      loginError: "Login error",
      loginSuccess: "Login successful!",
      sdkNotLoaded: "Facebook SDK is not loaded. Please wait...",
      noTokenAvailable: "No token available. Please log in first.",
      channelCreatedFromEmbeddedSignup: "Channel created successfully from Embedded Signup!",
      channelCreatedSuccess: "Channel created successfully! Phone number added to WABA.",
      phoneAddedToWaba: "Phone number added to WABA successfully! The list will be updated automatically.",
      wabaAddedToList: "WABA added to list!",
      businessTokenObtained: "Business token obtained successfully!",
      tokenExchangeError: "Error exchanging code for token. Using app token as alternative.",
      embeddedSignupOptions: "Options",
      embeddedSignupOptionsTitle: "Embedded Signup Options",
      embeddedSignupVersion: "Version",
      embeddedSignupSessionInfoVersion: "Session Info Version",
      embeddedSignupFeatures: "Features",
      phoneVerificationUnauthorized: "Channel created, but could not verify phone. Token may not have required permissions.",
      phoneVerificationError: "Channel created, but there was a warning in phone verification",
      phoneVerificationDelayed: "Channel created successfully. Phone verification will be done automatically shortly.",
      appIdRequired: "App ID not configured. Please select an app.",
      configIdRequired: "Config ID not configured. Please configure the Embedded Signup Config ID.",
      resourceUnavailable: "Resource unavailable. Please verify that the App ID and Config ID are correct and that the domain is configured in the Facebook App.",
      permissionsRequired: "Required permissions were not granted.",
      invalidAppId: "Invalid App ID or not configured correctly.",
      sdkError: "Error verifying Facebook SDK. Try reloading the page.",
      domainNotConfigured: "Domain not configured in \"App Domains\"",
      domainConfigurationRequired: "Configure the domains in \"App Domains\" in the Facebook App Dashboard and try again.",
      loginOAuth: "Add Facebook",
      noAppSelected: "Please select an app first",
      appNotFound: "App not found",
      facebookAppIdRequired: "Facebook App ID not configured for this app",
      loginRedirect: "Redirecting to Facebook login...",
      loginError: "Error opening Facebook login",
      webhookConfigError: "Channel created, but there was a warning when configuring the webhook"
    },
    instagram: {
      login: "Add Instagram",
      noAppSelected: "Please select an app first",
      appNotFound: "App not found",
      configIdRequired: "Config ID not configured for this app",
      loginRedirect: "Redirecting to Instagram login...",
      loginError: "Error opening Instagram login",
      webhookConfigError: "Channel created, but there was a warning when configuring the webhook",
      channelCreated: "Instagram channel created successfully!"
    },
  },
  configuracaoMotivo: {
    title: "Demands",
  ...
  configuracoesGerais: {
    labels: {
      ...
      webPushChatInterno: "Web Push for Internal Chat",
      ...
      audioPlugin: 'Using Audio Plugin ',
      audioModule: 'Using audio module with Waves ',
      ...
      messageListingType: "Message Listing Type",
      messageListingTypeDefault: "Default",
      messageListingTypeByQueue: "History by Queue",
      messageListingTypeComplete: "Complete History",
      messageListingTypeByTicket: "History by Ticket",
      chatbotFlow: "Active flow for the Bot service",
      forcePending: "Force current user when changing ticket status to pending",
      maxAttemps: "Maximum number of times the business hours message should be sent to the client.",
      limitTickets: "Number of tickets that should be consulted in services.",
      limitePrivate: "Number of messages that should be loaded in the internal chat per service.",
      erroMessage: "Send stopped messages",
      solveMessage: "Resolve Messages",
      validate: "Validate All Contacts",
      minutes: "10 minutes",
      hours: "1 hour",
      day: "1 day",
      days5: "5 days",
    ...
    captions: {
      ...
      webPushChatInterno: 'When activating this option, the system will send push notifications when new messages are received in the internal chat.',
      ...
      messageListingType: "Defines how messages are listed in history. Default: respects grouping configuration (with groupTickets: complete contact/channel history; without groupTickets: same queue only). By Queue: queue-segmented history with privacy (admin: complete history; user: only allowed queues using historical queueId). Complete: complete contact/channel history for everyone. By Ticket: only messages from current ticket.",
      chatbotFlow: "Flow to be used by the Bot for new services",
      chatbotFix: "By enabling this option, connections will stop floating in the footer and will be fixed at the top of the service list.",
      forcePending: "By enabling this option, the ticket will maintain the user associated with the service when changing the status from open to pending.",
      maxAttemps: "Enter here the number of times the absence message can be sent for each service...",
      limitTickets: "Enter here the number of tickets that should be searched on the service screen...",
      limitePrivate: "Enter here the number of messages that should be searched in the internal chat...",
      erroMessage: "This command will send stopped messages in the system.",
      solveMessage: "This command will remove messages with errors from the system.",
      validate: "This command will validate the number of all system contacts",
    },
    notifications: {
  ...
  contactsModal: {
    ...
    duplicatedContact: "This contact already exists in the database, it is not possible to add it again.",
  ...
  contacts: {
    ...
    addTagsInsteadOfReplace: 'Add tags instead of replace',
    addTagsTooltip: 'When checked, selected tags will be added to existing contact tags. When unchecked, all contact tags will be replaced by selected tags.',
    addTagsWarning: 'When checking this option, selected tags will be added to existing contact tags without removing previous tags.',
    tagsColumn: "Tags",
    kanbanColumn: "Kanban",
    actionsColumn: "Actions",
  ...
  customizar: {
    ...
    encryptionkey: {
      ...
      warningTitle: "Warning: Encryption Key Change",
      warningText: "Changing this key will affect user authentication. Users may need to log in again.",
      warningChangeKey: "WARNING: Changing the encryption key will make all previously encrypted data incompatible.\n\nThis may cause:\n• Failure to decrypt old passwords/tokens\n• Need to reconfigure integrations\n• Possible loss of access to encrypted data\n\nDo you want to continue?",
      warningAfterUpdate: "Remember: Data encrypted with the previous key may no longer be accessible.",
      errorKeyTooShort: "The encryption key must be at least 16 characters long",
    ...
    notifications: {
      ...
      successUpdateLogoScreen: "Login screen model updated successfully.",
      errorUpdateLogoScreen: "Error updating login screen model."
    },
  },
  common: {
    continue: "Continue",
  ...
  horarioAtendimento: {
    ...
    notifications: {
      ...
      validationError: "Business hours validation error. Please fix the errors before saving.",
      saveError: "Error saving business hours."
    },
  },
  businessHours: {
    warnings: {
      ...
      gap: "Schedules must be consecutive, without gaps between periods.",
      invalidPeriod: "Start time must be less than end time in each period.",
      missingTime: "All schedules must be filled in."
    },
    days: {
      0: "Sunday",
      1: "Monday",
  ...
  galeria: {
    ...
    viewFile: "View file",
    delete: "Delete",
    deleteConfirm: "Do you really want to delete the file \"{fileName}\"?",
    deleteSuccess: "File deleted successfully!",
    deleteError: "Error deleting file",
    uploadSuccess: "File(s) uploaded successfully!",
    uploadError: "Error uploading file(s)",
  ...
  instagramComentarios: {
    ...
    errorLoadingMoreMedia: 'Error loading more media',
    errorLoadingComments: 'Error loading comments',
    errorLoadingMoreComments: 'Error loading more comments',
    errorSendingReply: 'Error sending reply',
    replySent: 'Reply sent successfully!',
    delete: 'Delete',
    deleteComment: 'Delete Comment',
    deleteConfirmation: 'Do you really want to delete this comment?',
  ...
  provedorGlobal: {
    ...
    form: {
      ...
      hostLocked: "Host is automatically set for this provider type",
      metaAlwaysGlobal: "Meta types (WABA, Instagram, Messenger) are always global and cannot have specific tenants",
      token: "Token",
      tokenRequired: "Token is required",
      status: "Status",
      isGlobal: "Available for all tenants",
      description: "Description",
      groqCloudSection: "GroqCloud Configuration",
      groqCloudEnabled: "GroqCloud Enabled",
      groqCloudDisabled: "GroqCloud Disabled",
      groqCloudApiKey: "GroqCloud API Key",
      groqCloudLanguage: "GroqCloud Language",
      groqCloudModel: "GroqCloud Model",
      groqCloudAlwaysGlobal: "GroqCloud is always global and cannot have specific tenants"
    },
    modal: {
      createTitle: "Create Global Provider",
      editTitle: "Edit Global Provider"
    },
    tenantsModal: {
      title: "Manage Tenants",
      globalInfo: "This configuration is available for all tenants (Global).",
      selectTenant: "Select a Tenant",
      add: "Add Tenant",
      addSuccess: "Tenant added successfully!",
      addError: "Error adding tenant",
      removeConfirm: "Do you really want to remove this tenant?",
      removeSuccess: "Tenant removed successfully!",
      removeError: "Error removing tenant"
    },
    success: {
      created: "Global provider created successfully!",
      updated: "Global provider updated successfully!"
    },
    errors: {
      listError: "Error listing global providers",
      saveError: "Error saving global provider",
      metaTypeAlreadyExists: "A global provider of type {type} already exists. Only one provider of each Meta type is allowed."
    },
    delete: {
      confirm: "Do you really want to delete the global provider {name}?",
      success: "Global provider deleted successfully!",
      error: "Error deleting global provider"
    }
  },
  modalTenant: {
    visibleMenu: {
  ...
  appWaba: {
    title: 'App WABA Settings',
    tenant: 'Tenant',
    appId: 'App ID',
    apiVersion: 'API Version',
    description: 'Description',
    token: 'Token',
    tokenHint: 'Business Manager token for creating WABA channels',
    configId: 'Config ID (Embedded Signup)',
    configIdHint: 'Embedded Signup configuration ID for WhatsApp Business',
    appSecret: 'App Secret',
    appSecretHint: 'Facebook App Secret for OAuth code exchange',
    redirectUri: 'Redirect URI',
    redirectUriHint: 'OAuth redirect URI (must be exactly the same as configured in Facebook App Dashboard)',
    status: 'Status',
    isActive: 'Active',
    active: 'Active',
    inactive: 'Inactive',
    ...
    deleteConfirm: 'Are you sure you want to delete configuration #{id}?',
    error: 'Error processing configuration',
    deleteError: 'Error deleting configuration',
    listError: 'Error listing configurations',
    ...
    appInstagramIdHint: 'Instagram application ID (Instagram App ID)',
    appInstagramSecret: 'Instagram App Secret',
    appInstagramSecretHint: 'Instagram App Secret for OAuth code exchange',
    redirectUriInstagram: 'Instagram Redirect URI',
    redirectUriInstagramHint: 'Instagram OAuth redirect URI (must be exactly the same as configured in Instagram App Dashboard)',
    facebookSettings: 'Facebook Settings',
    redirectUriFacebook: 'Facebook Redirect URI',
    redirectUriFacebookHint: 'Facebook OAuth redirect URI (must be exactly the same as configured in Facebook App Dashboard)'
  },
  tenantQueue: {
    title: "Task Queues",
  ...
  wavoip: {
    ...
    tokensModal: {
      ...
      baileysInfo: "For Baileys connections, the system automatically reuses the existing session.",
      otherApiInfo: "For {type} connections, you will need to read two QR Codes:",
      systemQrCode: "The system QR Code (generated when connecting the channel)",
      wavoipQrCode: "The Wavoip QR Code (available in this modal when disconnected)",
      note: "<strong>Note:</strong> The QR Code available in this modal is the <strong>Wavoip</strong> QR Code.",
      tokenLabel: "Token {index}",
      disconnected: "Disconnected",
      disconnectedMessage: "The token is not connected. Click the button below to view the <strong>Wavoip QR Code</strong>.",
      rememberSystemQr: "<strong>Remember:</strong> You will also need to read the system QR Code for this connection.",
      openQrCodeButton: "Open Wavoip QR Code",
      connected: "Connected",
      connectedMessage: "The token is connected and working normally.",
      checkStatusMessage: "Click \"Update Status\" to check the status of this token.",
      updateStatus: "Update Status",
      close: "Close",
      viewTokensTooltip: "View Wavoip tokens"
    }
  },
  error404: {
    title: "404",
  ...
  login: {
    ...
    a2fCodeSent: "Two-factor authentication code sent",
    outOfServiceHours: "Outside service hours",
    invalidTenant: "Invalid tenant",
    limitError: "Limit error",
    licenseErrorUser: "License error user",
    licenseDomainError: "License domain error",
    licenseErrorServer: "License error server"
  },
  validateA2F: {
    title: "2FA Code Validation",
    message: "An authentication code has been sent to your {channel}.",
    ...
    loginError: "Error completing login",
    validationError: "Error validating code",
    invalidCodeError: "Invalid authentication code",
    expiredCodeError: "Authentication code expired. Please log in again.",
    invalidSessionError: "Invalid or expired session. Redirecting to login...",
    redirectingToLogin: "Redirecting to login...",
    codeResent: "Code resent successfully",
    resendError: "Error resending code",
    timeRemaining: "Time remaining: {time}",
    codeExpired: "Code expired. Redirecting to login...",
    resendCooldown: "Wait {seconds}s to resend",
    resendLimitError: "Wait 1 minute before resending the code"
  },
  configuracoesA2F: {
    enableA2F: "Enable Two-Factor Authentication",
    enableA2FCaption: "Enable two-factor authentication to increase access security",
    channelLabel: "Sending Channel",
    whatsappLabel: "WhatsApp Connection",
    wabaTemplateLabel: "WABA Template (AUTHENTICATION)",
    messageLabel: "Custom Message",
    messageHint: "Use {code} to automatically insert the code",
    infoText: "The code will be sent via {channel} when the user logs in. Make sure users have a registered phone (for WhatsApp) or valid email (for Email).",
    templateListError: "Error loading WABA templates",
    wabaMessageWarning: "When using WABA, the template text will be used. The custom message will not be applied.",
    emailSmtpConfigured: "The SMTP settings defined in Settings > SMTP will be used.",
    emailSmtpNotConfigured: "Configure SMTP in Settings > SMTP to send 2FA codes via email.",
    smsProviderLabel: "SMS Provider",
    smsInfo: "Configure the selected SMS provider token in tenant settings to send 2FA codes."
  },
  resetPassword: {
  ...
  atendimentoChat: {
    ...
    forwardToPrivateChat: "Forward to Private Chat",
    selectPrivateChatUser: "Select a user",
    selectPrivateChatUserHint: "Type to search for a user",
    userNotSelected: "Select a user",
    messageNotSelected: "Message not found",
    messageSentToPrivateChat: "Message forwarded to {name}",
    forwardToOtherChannel: "Forward to Other Channel",
    selectDestinationChannel: "Select destination channel",
    selectDestinationChannelHint: "Choose the channel where the message will be forwarded",
    channelNotSelected: "Select a channel",
    channelNotFound: "Channel not found",
    messageSentToOtherChannel: "Message forwarded to {name} on channel {channel}",
  },
  ...
  atendimentoItemTicket: {
    ...
    notifications: {
      aguardeEnvio: "Wait for the message to be sent before changing tickets",
    },
  },
  inputMensagem: {
    novo: {
    ...
    labels: {
      ...
      enviarArquivoGaleria: "Send File from Gallery",
      selecionarArquivoGaleria: "Select File from Gallery",
      ...
      enviarAgenteHumano: "Send with Human Agent",
      descricaoAgenteHumano: "This message will be sent with the HUMAN_AGENT tag, allowing you to send messages even outside the 24-hour window (within 7 days).",
      ...
      send: "Send",
      cancel: "Cancel",
      selectMarketingTemplate: "Select a marketing template to send",
      selectTemplateMessenger: "Select a template to send",
      templateCategory: "Template Category",
      marketing: "Marketing",
      utility: "Utility",
      templateName: "Template Name",
      enterTemplateName: "Enter the utility template name",
      utilityTemplateInfo: "Utility templates are sent within the 24-hour window after the user's last message.",
      noTitle: "No title",
      status: "Status",
      token: "Token",
      nextSend: "Next send",
      whatsappNotFound: "WhatsApp channel not found",
      errorLoadingTemplates: "Error loading templates",
      selectTemplate: "Select a template",
      pageIdNotFound: "Page ID not found",
      tokenNotFound: "Notification token not found",
    ...
    wabaErrors: {
      ...
      invalidFileTypeWithExtensions: "File type not supported for WABA: {fileName}. Allowed extensions: {extensions}",
  ...
  atendimentoInfoCabecalho: {
    ...
    selectDestinationQueue: "Select destination queue",
    ...
    linksTab: "Links",
    docsTab: "Docs",
    loadingMediaLinksDocs: "Loading media, links and documents...",
    autoScroll: "Auto scroll",
    autoScrollDescription: "Disables automatic scrolling when new messages arrive",
  ...
  generalSupport: {
    ...
    includeClosedTickets: "Include closed tickets",
    returnMenu: "Return to Menu",
    ...
    filterByConnections: "Connection ",
    filterByUser: "User ",
    filterByTags: "Tags ",
    ...
    sortByAnswered: "Sort by Not Answered",
    protocol: "Protocol",
    ...
    transferSelectedTickets: "Transfer selected tickets",
    markAsRead: "Mark as Read",
  ...
  dashTickets: {
    ...
    transferBetweenQueuesButtonLabel: 'Transfer between queues',
    transferBetweenChannelsButtonLabel: 'Transfer between channels',
    transferBetweenQueuesTitle: 'Transfer tickets between queues',
    transferBetweenQueuesDescription: 'Select the source queue and destination queue',
    sourceQueueLabel: 'Source Queue (leave empty to transfer all without queue)',
    destinationQueueLabel: 'Destination Queue *',
    destinationUserLabel: 'Destination User (optional)',
    transferBetweenChannelsTitle: 'Transfer tickets between channels',
    transferBetweenChannelsDescription: 'Select the source channel and destination channel',
    sourceChannelLabel: 'Source Channel',
    destinationChannelLabel: 'Destination Channel *',
    selectSourceChannelError: 'Select the source channel!',
    selectDestinationQueueError: 'Select the destination queue!',
    selectDestinationChannelError: 'Select the destination channel!',
    transferBetweenQueuesSuccess: 'Tickets successfully transferred between queues',
    transferBetweenChannelsSuccess: 'Tickets successfully transferred between channels',
    transferBetweenQueuesError: 'Error transferring tickets between queues',
    transferBetweenChannelsError: 'Error transferring tickets between channels',
  },
  dashBoard: {
  ...
  home: {
    welcome: "Welcome",
    user: "User",
    subtitle: "Quickly access the main system features",
    dashboard: "Dashboard",
    dashboardDescription: "View statistics and performance metrics",
    attendance: "Tickets",
    attendanceDescription: "Manage your tickets and conversations",
    contacts: "Contacts",
    contactsDescription: "View and manage your contact list",
    quickInfo: "Quick Information",
    info1: "Access the dashboard for detailed analytics",
    info2: "System optimized for better performance",
    info3: "Browse the menu for more features",
    quickLinks: "Quick Links",
    reports: "Reports",
    reportsDescription: "View reports and analytics",
    settings: "Settings",
    settingsDescription: "Configure the system according to your needs"
  },
  confirmation: {
  ...
  menuCategories: {
    ...
    dashboard: 'Dashboard',
    atendimento: 'Service',
    gestaoComercial: 'Commercial Management',
    comunicacaoMarketing: 'Communication & MKT',
    administracao: 'Administration',
    gestao: 'Management',
    configuracao: 'Configuration and API',
    tenantsLicenciamento: 'Tenants & Licensing',
    configuracoes: 'Settings',
    canaisIntegracao: 'Channels & Integration',
    sistema: 'System'
  },
  menu: {
    instagramComentarios: {
      title: 'Instagram Comments',
      caption: 'Manage comments'
    },
    funil: {
      title: 'Funil',
  ...
  menuSuperAdmin: {
    ...
    provedoresGlobais: {
      title: 'Global Providers',
      caption: 'Global Provider Configurations'
    }
  },
  menuBloqueio: {
    configuracoes: {
  ...
  relatorioBulkDispatch: {
    title: 'Bulk Dispatch Report',
    tooltip: {
      description: 'This report shows only WhatsApp message dispatches. It does not include Wavoip or SMS dispatches.'
    },
    filters: {
      status: 'Status',
    ...
    dispatchType: {
      template: 'Template',
      template_variable: 'Template with Variables',
      text: 'Text',
      text_variable: 'Text with Variables'
    },
    details: {
    ...
    notifications: {
      ...
      errorLoadingDetails: 'Error loading dispatch details'
    }
  },
  massaSMS: {
    form: {
  ...
  massaTexto: {
    ...
    notifications: {
      ...
      messagesSent: 'Messages sent: {sent} of {total}.',
      errorSendingMessages: 'Error sending messages.',
  ...
  massaTemplate: {
    ...
    form: {
      ...
      closeTicket: 'Close ticket after sending',
    },
    notifications: {
  ...
  massaTemplateVariavel: {
    ...
    notifications: {
      messagesSent: 'Templates sent: {sent} out of {total}.',
      uploadingMessages: 'Please wait, sending messages... Do not close this page until the sending is complete.',
      chooseConnection: 'Please select a connection.',
  ...
  sessao: {
    ...
    revalidateCoexWebhook: 'Revalidate COEX Webhook',
    revalidateConnection: 'Revalidate Connection',
    coexWebhookRevalidated: 'COEX Webhook revalidated successfully!',
    metaTokenNotFound: 'Meta Token not found. Configure the token in the settings section.',
    phoneNumberIdNotFound: 'Phone number ID not found.',
    chatbot: 'ChatBot',
    queue: 'Queue',
    user: 'User',
    qrCode: 'QR Code',
  ...
  sessaoItemStatus: {
    ...
    lastUpdate: 'Last Update',
    contingencyInactive: 'Contingency'
  },
  sessaoModalQrcode: {
  ...
  sessaoModalWhatsapp: {
    ...
    configureAfterCreate: 'This field can be configured after creating the channel',
    type: 'Type',
    ...
    enable: {
      webPush: 'Enable Web Push ',
      webPush2: 'Enabling this option will send notifications to the APP.',
      contingency: 'Contingency',
      contingency2: 'If active: the channel is active and will receive messages. If inactive: the channel will remain connected, but will not receive messages.',
      ...
      ignoreBussinesHours: 'Ignore Business Hours',
      ignoreBussinesHours2: 'Ignores the system business hours.',
    ...
    whatsappTypes: {
      ...
      meow: 'WhatsApp Meow (QRCode)',
      evo: 'WhatsApp Evolution (QRCode)',
      telegram: 'Telegram',
      hub: 'Hub NotificaMe',
    },
    ...
    instagramError: 'Oops! Incorrect Instagram data, verify if the Page ID, token, and permissions are correct and if the Instagram Business account is linked to the Facebook page...',
  ...
  nodeForm: {
    ...
    selfDistribution8: 'Sequential',
    selfDistribution9: 'Sequential: Will distribute tickets sequentially and rotationally among available attendants.',
    emoji: 'Emoji',
    chatbotBlock: {
  ...
  common: {
    sendMarketing: 'Send Marketing Template',
    noQueue: 'No queue',
    required: 'Required',
  ...
  configuracaoMetaPanel: {
    ...
    templates: {
      ...
      facebook: "Facebook",
      selectMessengerConnection: "Select Messenger Connection",
      noMessengerConnectionsAvailable: "No Messenger connection available",
      noMessengerConnections: "No Messenger connection found. Please set up a Messenger connection first in the Communication Channels section.",
      ...
      // Warnings
      warnings: {
        marketingConvertedToUtility: "Template created as UTILITY. Marketing templates in Messenger require notification_message_tokens via user opt-in and cannot be created through the message_templates endpoint."
      },
      errors: {
        ...
        noValidComponents: "Add at least one valid component (HEADER, BODY or BUTTONS)"
      },
      
      // Missing translations
      facebookCreateComingSoon: "Facebook template creation will be available in upcoming versions.",
      wabaCreateComingSoon: "WABA template creation will be available in upcoming versions.",
      noTemplatesFound: "No templates found for this connection.",
      messengerCategoryHint: "Messenger only supports UTILITY templates. Marketing templates require notification_message_tokens via user opt-in.",
      use: "Use",
      payload: "Payload"
    },
    phones: {
    ...
    instagram: {
      title: "Instagram",
      selectInstagramConnection: "Select Instagram Connection",
      noInstagramConnectionsAvailable: "No Instagram connection available",
      noInstagramConnections: "No Instagram connection found. Please set up an Instagram connection first in the Communication Channels section.",
      selectConnectionToManage: "Select an Instagram connection to manage the account.",
      verifyAccount: "Verify Account",
      selectInstagramFirst: "Select an Instagram connection first",
      accountInfoLoaded: "Account information loaded successfully!",
      accountCheckError: "Error verifying Instagram account",
      connectionInfo: {
        title: "Instagram Connection Information",
      ...
      tips: {
        ...
        accountVerification: {
          ...
          description: "Make sure the Instagram account is connected and active in Meta Business Manager."
        },
        facebookBusinessManager: {
          title: "Facebook Business Manager",
          description: "Access: Business Manager → Instagram → Connected Accounts"
        }
      }
    },
    messenger: {
      ...
      noMessengerConnectionsAvailable: "No Messenger connection available",
      noMessengerConnections: "No Messenger connection found. Please set up a Messenger connection first in the Communication Channels section.",
      selectConnectionToManage: "Select a connection to manage",
      verifyPage: "Verify Page",
      selectMessengerFirst: "Please select a Messenger connection first",
      pageInfoLoaded: "Page information loaded successfully!",
      pageCheckError: "Error verifying Messenger page",
      connectionInfo: {
      ...
      tips: {
        ...
        pageVerification: {
          ...
          description: "Make sure the Facebook page is verified and has the necessary permissions for Messenger."
        },
        facebookBusinessManager: {
          title: "Facebook Business Manager",
          description: "The page must be linked to Facebook Business Manager and have Messenger permissions configured."
        }
      }
    },
    facebook: {
      title: "Facebook",
      selectFacebookConnection: "Select Facebook Connection",
      noFacebookConnectionsAvailable: "No Facebook connection available",
      noFacebookConnections: "No Facebook connection found. Please set up a Facebook connection first in the Communication Channels section.",
      selectConnectionToManage: "Select a connection to manage",
      verifyPage: "Verify Page",
      selectFacebookFirst: "Please select a Facebook connection first",
      pageInfoLoaded: "Page information loaded successfully!",
      pageCheckError: "Error verifying Facebook page",
      connectionInfo: {
        title: "Connection Information",
        pageId: "Page ID",
        wabaId: "WABA ID",
      ...
      tips: {
        ...
        pageVerification: {
          title: "Page Verification",
          description: "Make sure the Facebook page is verified and has the necessary permissions."
        },
        facebookBusinessManager: {
          title: "Facebook Business Manager",
          description: "The page must be linked to Facebook Business Manager and have permissions configured."
        }
      }
    },
    phoneRegistration: {
    ...
    messages: {
      selectConnectionToManage: "Select a connection to manage templates",
    ...
    notifications: {
      ...
      noMessengerConnectionsFound: "No Messenger connection found. Please set up a Messenger connection first.",
      selectMessengerToList: "Select a Messenger connection to list templates.",
      ...
      noWabaConnectionsFound: "No WABA connection found. Please set up a WABA connection first.",
      selectWabaToList: "Select a WABA connection to list templates.",
      noMessengerConnectionsFound: "No Messenger connection found. Please set up a Messenger connection first.",
      selectMessengerToList: "Select a Messenger connection to list templates.",
      codeExpiredDialog: {
        title: "Expired Code",
  ...
  migration: {
    ...
    migrationInfoTitle: 'Migration Information',
    migrationInfoDescription: 'Migrate a complete tenant from one VPS to another, including all data and files.',
    requirements: 'Requirements',
    remoteDatabase: 'Remote Database Configuration',
    dbHost: 'Host',
    dbPort: 'Port',
    dbDialect: 'Dialect',
    ...
    sshPasswordOrKey: 'Or use private key',
    sshPrivateKey: 'SSH Private Key',
    zproBasePath: 'ZPRO Base Path',
    publicFolderPath: 'Public Folder Path',
    ...
    close: 'Close',
    confirm: 'Confirm',
    chooseMigrationType: 'Choose migration type:',
    fullMigration: 'Full Migration (Database + Files)',
    databaseOnly: 'Database Only',
    filesOnly: 'Files Only',
    loadSavedConfig: 'Load saved configuration',
    saveConfig: 'Save configuration',
    clearSavedConfig: 'Clear saved configuration',
    savedConfigAvailable: 'Saved configuration available. Click the save icon (green) to load.',
    configSavedSuccess: 'Configuration saved successfully',
    configSavedMessage: 'Configuration has been saved and can be reused',
    configSaveError: 'Error saving configuration',
    configLoadedSuccess: 'Configuration loaded successfully',
    configSavedAt: 'Saved at:',
    noSavedConfig: 'No saved configuration found',
    configLoadError: 'Error loading configuration',
    confirmClearConfig: 'Do you really want to clear the saved configuration?',
    configClearedSuccess: 'Saved configuration has been removed',
    configClearError: 'Error clearing configuration',
    databaseMigrationStarted: 'Database migration started successfully',
    databaseMigrationError: 'Error starting database migration',
    filesMigrationStarted: 'Files migration started successfully',
    filesMigrationError: 'Error starting files migration',
    migrationLogs: 'Migration Logs',
    refreshLogs: 'Refresh logs',
    downloadLog: 'Download log',
    noLogsAvailable: 'No logs available',
    logsLoadError: 'Error loading logs',
    logDownloadSuccess: 'Log downloaded successfully',
    logDownloadError: 'Error downloading log',
    retryDatabase: 'Retry Database Migration',
    retryFiles: 'Retry Files Migration',
    pause: 'Pause',
    pauseSuccess: 'Migration paused successfully',
    pauseError: 'Error pausing migration'
  },
  updateNotification: {
    title: 'New version available!',
    message: 'A new version of the application is available. Update to get the latest improvements. On desktop, update with the command Ctrl+Shift+R.',
