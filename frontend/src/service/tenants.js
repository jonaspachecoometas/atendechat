...
export function AlterarTenantMessageListingType (data) {
  return request({
    url: `/tenantsMessageListingType/${data.id}`,
    method: 'put',
    data
  })
}

export function AlterarTenantA2F (data) {
  return request({
    url: `/tenantsA2F/${data.id}`,
    method: 'put',
    data
  })
}
...
export function AlterarTenantWebPushChatInterno (data) {
  return request({
    url: `/tenantsWebPushChatInterno/${data.id}`,
    method: 'put',
    data
  })
}